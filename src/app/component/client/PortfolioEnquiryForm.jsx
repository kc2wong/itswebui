...
class PortfolioEnquiryForm extends Component<IntProps, State> {
    ...
    render() {
        ...
        const { exchangeCode, pageNum, pageSize, searchResultColSpec, securityPositionSummary } = this.state;
        const totalMarketValue = _.sumBy(securityPositionSummary, "marketValueBaseCurrency")
        ...
        return (
                        ...
                        <XcGrid>
                            <XcGrid.Row>
                                ...
                                <XcGrid.Col alignRight={true} width={4}>
                                    ...
                                    <XcGrid.Col alignRight={true} width={4}>
                                        {xlate("portfolioEnquiryForm.totalMarketValue", [totalMarketValue.toString()])}
                                    </XcGrid.Col>
                            </XcGrid.Row>
                        </XcGrid>
                    </XcPanel.Footer>
            ...
            // <XcForm model={this.state.searchCriteria} name="portfolioEnquiryForm" onSubmit={this.handleSearch} style={{height: "100vh"}} >
    ...
    search = () => {
        ...
        if (selectedTradingAccount) {
            ...
            if (promise) {
                promise.then(
                    result => {
                        console.log(result.tradingAccountPortfolio.securityPositionSummary)
                        this.setState({ securityPositionSummary: result.tradingAccountPortfolio.securityPositionSummary })
                    },
                    error => {
                        // TODO                
                    }
